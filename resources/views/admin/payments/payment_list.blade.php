    ...
    <body>
        ...
        <div class="main">
            <div class="container3">
                ...
                <h1 class="admin-header"><img src="{{ asset('assets/images/cash-on-delivery.png') }}" alt="" style ="height:75px; width:75px object-fit-contain" class ="pb-3">Payments</h1>
                </div>
