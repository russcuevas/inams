    ...
    <body>
        ...
        <div class="main">
            <div class="container3">
                <div class="my-3 text-center border-bottom">
                <h1 class="display-4 fw-bold" style ="color:#013237; margin-left:190px;"><img src="{{ asset('assets/images/optimizing.png') }}" alt="" style ="height:75px; width:75px object-fit-contain" class ="pb-3 my-3">Maintenance</h1>
        
                <!-- Card Container -->
        
                <div class="card" style="max-width: 15rem;">
                <div class="card-header">Total Maintenance Requests</div>
                    <div class="card-body">
